...
var randomquestionlist = [
    ...
    [`What will be the output of the following code snippet?`,`<script type="text/javascript">
    \n a = 5 + "9"; document.write(a); </script>`,`Compilation Error`,`14`,`Runtime Error`,`59`,4],
